...
int main(int argc, char* argv[]) {
	...
	std::vector<std::string> maps = { "BlueShiftLE.SC2Map","16-BitLE.SC2Map", "LostAndFoundLE.SC2Map", "DarknessSanctuaryLE.SC2Map", "AcidPlantLE.SC2Map",  "DreamcatcherLE.SC2Map", "CatalystLE.SC2Map" };
	while (true)
	{
