...
public:
	...
	{
		auto strat = new ExpandStrategy(ABILITY_ID::BUILD_COMMANDCENTER, false, false);
		return Util::TryBuildBuilding(ABILITY_ID::BUILD_COMMANDCENTER, UNIT_TYPEID::TERRAN_COMMANDCENTER, obs, actions, query, debug, state, strat);
	}
