...
class ShieldUpgradeGoal : public BaseAction
{
public:
	uint32_t idx = 0;
	...
	ShieldUpgradeGoal() : BaseAction() {
		...
		upgrades.push_back(UPGRADE_ID::PROTOSSSHIELDSLEVEL3);
		abilities.push_back(sc2::ABILITY_ID::RESEARCH_PROTOSSSHIELDSLEVEL1);
		abilities.push_back(sc2::ABILITY_ID::RESEARCH_PROTOSSSHIELDSLEVEL2);
		abilities.push_back(sc2::ABILITY_ID::RESEARCH_PROTOSSSHIELDSLEVEL3);
