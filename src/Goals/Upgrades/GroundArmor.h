...
class GroundArmorUpgradeGoal : public BaseAction
{
public:
	uint32_t idx = 0;
	vector<UPGRADE_ID> upgrades;
	vector<ABILITY_ID> abilities;
	GroundArmorUpgradeGoal() : BaseAction() {
		upgrades.push_back(UPGRADE_ID::PROTOSSGROUNDARMORSLEVEL1);
		upgrades.push_back(UPGRADE_ID::PROTOSSGROUNDARMORSLEVEL2);
		upgrades.push_back(UPGRADE_ID::PROTOSSGROUNDARMORSLEVEL3);
		abilities.push_back(sc2::ABILITY_ID::RESEARCH_PROTOSSGROUNDARMORLEVEL1);
		abilities.push_back(sc2::ABILITY_ID::RESEARCH_PROTOSSGROUNDARMORLEVEL2);
		abilities.push_back(sc2::ABILITY_ID::RESEARCH_PROTOSSGROUNDARMORLEVEL3);
