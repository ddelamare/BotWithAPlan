...
public:
	...
	{
		this->conditions.push_back(new BaseCondition("Build Cyber", 6, sc2::UNIT_TYPEID::PROTOSS_PYLON, 1, sc2::UNIT_TYPEID::PROTOSS_STARGATE, 1, sc2::UNIT_TYPEID::PROTOSS_PROBE, 1));
